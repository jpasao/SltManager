export const stlLogo = [
  '180 180',
  `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 31 31" class="icon icon-xxl" role="img" aria-hidden="true">
      <style type="text/css">
        path.iconLogo{fill:url(#MyGradient)}
      </style>
      <defs>
        <linearGradient id="MyGradient">
          <stop offset="5%" stop-color="var(--cui-primary)" />
          <stop offset="95%" stop-color="var(--cui-secondary)" />
        </linearGradient>
      </defs>
